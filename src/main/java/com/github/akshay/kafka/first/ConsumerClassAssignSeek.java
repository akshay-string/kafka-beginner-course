...
public class ConsumerClassAssignSeek
{
    public static void main(String[] args)
    {
        ...
        Logger logger = LoggerFactory.getLogger(ConsumerClassAssignSeek.class.getName());
        ...
        // Assign & Seek is used for replaying data or specific message

        //Assignment
        long offSetToReadFrom = 5L;
        TopicPartition partitionToReadFrom = new TopicPartition(consumerTopic, 0);
        ...
        while(keepOnReading)
        {
            ...
            for (ConsumerRecord<String, String> record : records)
            {
                ...
                messagesRead += 1;
                if (numberOfMessageToRead <= messagesRead)
                {
                    keepOnReading = false;
                    break;
                }
